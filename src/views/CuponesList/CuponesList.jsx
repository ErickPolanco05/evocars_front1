    ...
    if (userInfo) {
      ...
      const fetchCupones = async () => {
        try {
          let response;
          if (role === 2) {
            response = await axios.get(`https://evocars-cristian-ps-projects.vercel.app/api/cupones/usuario/${id}`);
          } else if (role === 3) {
            response = await axios.get('https://evocars-cristian-ps-projects.vercel.app/api/cupones');
          }
