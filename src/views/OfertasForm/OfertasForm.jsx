...
const OfertasForm = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (id) {
        ...
        try {
          ...
          const response = await axios.get(`https://evocars-cristian-ps-projects.vercel.app/api/ofertas/${id}`);
          ...
          const autoResponse = await axios.get(`https://evocars-cristian-ps-projects.vercel.app/api/autos/detailed/${oferta.id_auto}`);
    ...
    const fetchAutoModel = async () => {
      if (!id) {
        ...
        if (id_auto) {
          try {
            const autoResponse = await axios.get(`https://evocars-cristian-ps-projects.vercel.app/api/autos/detailed/${id_auto}`);
            setOfertaData(prev => ({
              ...prev,
              id_auto: id_auto,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        await axios.put(`https://evocars-cristian-ps-projects.vercel.app/api/ofertas/${id}`, dataToSend);
      } else {
        await axios.post('https://evocars-cristian-ps-projects.vercel.app/api/ofertas', dataToSend);
      }
