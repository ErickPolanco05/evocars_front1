...
const UserForm = () => {
  ...
  useEffect(() => {
    if (id) {
      axios.get(`https://evocars-cristian-ps-projects.vercel.app/api/usuarios/${id}`)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (id) {
        await axios.put(`https://evocars-cristian-ps-projects.vercel.app/api/usuarios/${id}`, payload, {
          headers: {
            'Content-Type': 'application/json'
          }
        });
      } else {
        await axios.post('https://evocars-cristian-ps-projects.vercel.app/api/usuarios', payload, {
          headers: {
            'Content-Type': 'application/json'
          }
        });
